# ![LOGO](logo.png) Amazon QuickSight MSP Connector

## Description

A generated MSP connector for the Amazon QuickSight API (version 2018-04-01).
...
flowground :- Telekom iPaaS / amazonaws-com-quicksight-connector<br/>
